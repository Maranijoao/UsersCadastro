...
import { generateNavigation } from 'app/mock-api/common/navigation/data';
    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            ...
            .reply(({ request }) => {
                ...
                const flatNavigation = this._fuseNavigationService.getFlatNavigation(defaultNavigation);
